...
import 'package:task_app/demo%20Coupons.dart';
import 'package:task_app/demo%20Orders.dart';
import 'package:task_app/demo%20Wishlist.dart';

import 'main.dart';

class demoFlipkart extends StatefulWidget {
  const demoFlipkart({super.key});

  @override
  State<demoFlipkart> createState() => _demoFlipkartState();
}

class _demoFlipkartState extends State<demoFlipkart> {
  @override
                ...
                children: [
                  Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) =>demoorders(),));
                        },
                        //container Wrap with Row
                        child: Container(
                          height: width*0.11,
                          width: width*0.44,
                          decoration: BoxDecoration(
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => demoWishlist(),));
                        },
                        child: Container(
                          height: width*0.11,
                          width: width*0.44,
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Navigator.push(context,MaterialPageRoute(builder: (context) => demoCoupons(),));
                        },
                        child: Row(
                          children: [
                            Container(
